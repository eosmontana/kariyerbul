		...
		<header id="header">
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title text-center">ücretsiz hesabınızı oluşturun</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employer" class="btn btn-facebook btn-block mb-5-xs">işveren olarak kaydol</a>
						</div>
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">işçi olarak kaydol</a>
						</div>
					...
					<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label for="inputName">Adınız <span class="font10 text-danger">(required)</span></label>
											<input id="inputName" name="fullname" type="text" class="form-control" data-error="İsminiz gerekli!" required>
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label for="inputEmail">E-Posta Adresiniz <span class="font10 text-danger">(required)</span></label>
											<input id="inputEmail" name="email" type="email" class="form-control" data-error="Mail adresiniz gerekli!" required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="inputMessage">Mesaj <span class="font10 text-danger">(required)</span></label>
											<textarea id="inputMessage" name="message" class="form-control" rows="8" data-minlength="50" data-error="Mesajınız gerekli ve 50 karakterden az olamaz!" required></textarea>
											<div class="help-block with-errors"></div>
										</div>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Adres</h5>
										<address> MERSİN <br/>Erdemli </address>
								</li>
								<li>
										<h5>E-Posta</h5><a href="mailto:kariyerbul@gmail.com">kariyerbul@gmail.com</a>
								</li>
								<li>
										<h5>Telefon</h5><a href="tel:+905355553131">+905355553131</a>
								</li>
