 ...
 <script type="text/javascript">
	...
	if(document.getElementById('mymail').value == "")
   {
	alert("Lütfen mail adresinizi girin");
		  ...
		  document.getElementById("data").innerHTML = "Lütfen bekleyin...";
      var xmlhttp;
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Çalışan olarak kaydol </a>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
                                ...
                                <div class="modal-header">
                                <h4 class="modal-title text-center">Hesaba giriş yap</h4>
                                </div>
                                ...
                                <label>E-posta</label>
                                <input class="form-control" placeholder="E-posta adresinizi girin" name="email" required type="text"> 
                                </div>
                                ...
                                <div class="form-group"> 
                                <label>Şifre</label>
                                <input class="form-control" placeholder="Şifrenizi girin" name="password" required type="password"> 
                                </div>
