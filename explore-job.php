		...
		<header id="header">
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title text-center">Hesap oluştur</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">İşçi olarak kaydol</a>
						</div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="job-list.php">Tüm ilanlar</a></li>
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<ul class="meta-list clearfix">
										<li>
											<h4 class="heading">Konum:</h4>
											<?php echo "$jobcity"; ?> , <?php echo "$jobcountry"; ?>
										</li>
										<li>
											<h4 class="heading">Sona erme tarihi:</h4>
											<?php echo "$post_month"; ?> <?php echo "$post_date"; ?>, <?php echo "$post_year"; ?>
										</li>
										<li>
											<h4 class="heading">Deneyim</h4>
											<?php echo "$experience"; ?> 
										</li>
										<li>
											<h4 class="heading">Yayınlanma tarihi: </h4>
											<?php echo "$opendate"; ?>
										</li>
									</ul>
